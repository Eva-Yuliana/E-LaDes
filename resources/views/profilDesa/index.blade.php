...
<html lang="id">
  ...
  <body>
      ...
      <div class="container-fluid py-4">
        <div class="card card-government p-4 mb-4">
          <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
              <h1 class="h3 mb-0 text-white fw-semibold">Profil Desa</h1>
              <p class="mb-0 text-white-50">Informasi detail tentang desa</p>
            </div>
            <a href="{{ route('profilDesa.edit') }}" class="btn btn-light btn-icon-split shadow-sm">
          ...
          <div class="col-md-11">
            <div class="card shadow border-0">
              <div class="card-header card-government text-white py-3">
                <h5 class="mb-0 fw-semibold"><i class="bi bi-building me-2"></i>Informasi Desa</h5>
              </div>

              <div class="card-body p-4" id="profilDesaContainer">
                <!-- Data profil desa dimuat dari JavaScript -->
              </div>

              <div class="card-footer bg-white py-3 text-center">
                <small class="text-muted">Terakhir diperbarui: 21 Februari 2026</small>
              </div>
            </div>
          </div>
        </div>
    ...
    <script>
    // Data Profil Desa (dummy / bisa dari backend nanti)
      const profilDesa = {
        namaDesa: "Pesudukuh",
        kecamatan: "Bagor",
        kabupaten: "Nganjuk",
        provinsi: "Jawa Timur",
        alamat: "Jl. Raya Bagor No. 123, Bagor, Nganjuk 64392",
        kepalaDesa: "Nama Lengkap",
        nip: "197512151998031002",
        update: "21 Februari 2026",
      };

      // Ambil container
      const container = document.getElementById("profilDesaContainer");
  ...
  <div class="row g-4 py-2">
    ...
    <!-- ================= LOKASI ================= -->
    <div class="col-md-6">
      <div class="section-header bg-government-light mb-3">
        <h6 class="section-title"><i class="bi bi-geo-alt me-2"></i>Lokasi Desa</h6>
      </div>

      ${createItem("Nama Desa", profilDesa.namaDesa, "primary")}
      ${createItem("Nama Kecamatan", profilDesa.kecamatan, "info")}
      ${createItem("Nama Kabupaten", profilDesa.kabupaten, "info")}
      ${createItem("Nama Provinsi", profilDesa.provinsi, "info")}
    </div>

    <!-- ================= KEPALA DESA ================= -->
    <div class="col-md-6">
      <div class="section-header bg-government-light mb-3">
        <h6 class="section-title"><i class="bi bi-person-badge me-2"></i>Informasi Kepala Desa</h6>
      </div>

      ${createItem("Alamat Kantor Desa", profilDesa.alamat, "success")}
      ${createItem("Nama Kepala Desa", profilDesa.kepalaDesa, "warning")}
      ${createItem("NIP Kepala Desa", profilDesa.nip, "warning")}
    </div>

  </div>
`;

      // Function reusable (biar clean untuk laporan)
      function createItem(label, value, color) {
        return `
    <div class="card mb-3 border-left-${color} shadow-sm border-0 bg-light">
      <div class="card-body py-3">
        <label class="form-label fw-bold text-primary small">${label}</label>
