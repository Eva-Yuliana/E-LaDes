          ...
          <div class="col-12">
            <div class="card card-government">
              <div class="card-body py-4">
                <h2 class="fw-bold mb-2">Edit Pengumuman</h2>
                <p class="mb-0 opacity-75">Perbarui pengumuman yang ada</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="card-body p-4">
                ...
                <form id="pengumumanForm" action="#" method="POST">
                  <div class="mb-4">
                    ...
                    <input type="text" name="judul" id="judul" class="form-control" value="Pembayaran Bumdes" required />
                  </div>

                  <div class="mb-4">
                    <label for="isi" class="form-label">Isi Pengumuman</label>
                    <textarea name="isi" id="isi" class="form-control" rows="8" required>Untuk pembayaran bumdes bisa dibayar di waktu kerja atau di rumah Seketeris Desa</textarea>
                  </div>
                  ...
                  <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary btn-government px-4">Perbarui</button>
                  </div>
                </form>
              </div>
            </div>
