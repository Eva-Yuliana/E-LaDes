  ...
  <body>
    <div class="d-none d-md-block sidebar-government p-3">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <a href="{{ route('kabar.admin') }}" class="nav-link active"> <i class="bi bi-newspaper"></i> Kabar Desa </a>
        </li>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse mt-3" id="mobileNavbarNav">
          ...
          <ul class="navbar-nav mb-2">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="{{ route('kabar.admin') }}"> <i class="bi bi-newspaper"></i> Kabar Desa </a>
            </li>
          </ul>
              ...
              <div class="card-body py-4">
                <div class="row align-items-center">
                  ...
                  <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    <a href="kabar tambah.html" class="btn btn-light btn-lg">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
          <div class="col">
            <div class="card kabar-card h-100 shadow-sm border-0">
              <img src="/assets/img/picture.jpg" class="kabar-image" />
              <div class="card-body d-flex flex-column p-4">
                ...
                <h5 class="card-title text-government-primary fw-bold mb-2">TEST</h5>
                <p class="card-text text-muted flex-grow-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores facere aut enim corrupti itaque aperiam libero, quid...</p>
                <div class="mt-auto pt-3">
                  <div class="d-flex justify-content-between align-items-center">
                    <a href="kabar detail.html" class="btn btn-government btn-sm"> <i class="bi bi-eye me-1"></i> Lihat Detail </a>
                    <div class="btn-group">
                      <a href="kabar edit.html" class="btn btn-outline-warning btn-sm">
          ...
          <div class="col">
            <div class="card kabar-card h-100 shadow-sm border-0">
              ...
              <div class="card-body d-flex flex-column p-4">
                ...
                <div class="mt-auto pt-3">
                  <div class="d-flex justify-content-between align-items-center">
                    <a href="#" class="btn btn-government btn-sm"> <i class="bi bi-eye me-1"></i> Lihat Detail </a>
                    <div class="btn-group">
